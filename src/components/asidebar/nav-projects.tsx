...
const NavProjects = () => {
  ...
  const hasMore = pagination?.totalCount > pageNumber;
    ...
    <>
      <SidebarGroup className="group-data-[collapsible=icon]:hidden">
        <SidebarGroupLabel className="w-full justify-between pr-0">
          ...
          <PermissionsGuard requiredPermission={Permission.CREATE_PROJECT}>
            <button
              onClick={onOpen}
              type="button"
                ...
                <SidebarMenuItem key={item._id}>
                  ...
                  <DropdownMenu>
                    ...
                    >
                      ...
                      <PermissionsGuard
                        requiredPermission={Permission.DELETE_PROJECT}
                      >
                        <DropdownMenuSeparator />
                        <DropdownMenuItem
                          disabled={isLoading}
